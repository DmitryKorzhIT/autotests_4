...
def test_3():
    ...
    file_name = news_news_url.create_report_file(
        test_name="news_news_url_check_all_news", header=header
    )
...
def test_4():
    ...
    file_name = news_news_url.create_report_file(
        test_name="news_news_url_check_all_news_data", header=header
    )
