...
def test_5():
    ...
    file_name = competitions_and_results.create_report_file(
        test_name="competitions_and_results", header=header
    )
    ...
    for sport in range(len_sports):
        ...
        for year in range(len_years):
            ...
            flag_local = competitions_and_results.check_each_competition(
                file_name, sport_btn_text, year_btn_text
            )
